...
+
為了更好地理解 Essentials 套件中顯示的容量，您應該熟悉收費方式的運作原理 https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-licensing.html#notes-about-charging["了解 Essentials 套餐的收費"^]。
...
| 預先承諾的總容量 | 您從 NetApp 購買的總授權容量，包括 BYOL 授權和 Marketplace 合約。此值為 BYOL 總容量與 Marketplace 合約總容量的總和。 

...
=== 管理 Cloud Volumes ONTAP 授權

現在您可以透過主頁或 *Direct licenses* 標籤管理 Cloud Volumes ONTAP 授權。使用 *Marketplace subscriptions* 標籤檢視您的訂閱資訊。
...
https://docs.netapp.com/us-en/console-setup-admin/task-monitor-cm-operations.html["了解如何設定電子郵件通知"^]
...
Digital Wallet 現在會顯示您帳戶中已使用容量的總和以及按授權套件劃分的已使用容量。這有助於您了解收費方式以及是否需要購買額外容量。
